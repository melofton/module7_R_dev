...
So far, we have been working with daily mean chlorophyll-a values from Lake Barco.
...
```
First, we can look at variability in this 5-minute data over the course of a day to get a visual understanding of the daily variability in chlorophyll-a. Each colored line in the plot below represents a different day of chl-a data from midnight to midnight. For ease of visualization, we will only look at data from 2019-10-09 to 2019-10-12.
```{r}
...
**Q.XX** Examine the plot of high-frequency chlorophyll-a data. How variable is chlorophyll-a over the course of a day? 
...
Finally, we can generate a distribution of initial conditions for your forecast using the current chlorophyll-a (`curr_chla`) and a standard deviation in units of ug/L calculated from high-frequency data from Lake Barco (`ic_sd`).
...
**Q.XX** Examine the plots of high-frequency chlorophyll-a data (above) and of initial conditions uncertainty. How do you think daily variability in chlorophyll-a data affects the initial conditions uncertainty in our model?
