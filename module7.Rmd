...
```{r}
bias <- mean(exp(mod) - model_data$chla, na.rm = TRUE) 
bias
```
...
ic_sd <- mean(initial_condition_sd_dataframe$daily_sd_chla, na.rm = TRUE)
ic_sd
```
